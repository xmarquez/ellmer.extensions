...
This package extends [ellmer](https://github.com/tidyverse/ellmer) with
...
The package is integrated with `ellmer` generics, including
`batch_chat()`, `parallel_chat()`, and `batch_chat_structured()`.
