...
- [`openai_costs()`](https://xmarquez.github.io/ellmer.extensions/reference/openai_costs.md)
  for actual OpenAI organization costs by API key, project, or line
  item.
...
[`openai_costs()`](https://xmarquez.github.io/ellmer.extensions/reference/openai_costs.md)
retrieves actual charged amounts from OpenAI’s organization Costs API.
It automatically follows pagination and can filter or group reports by
API key ID, project ID, or line item.
